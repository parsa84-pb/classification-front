...
const VideoGalleryPage = () => {
  ...
  useEffect(() => {
    const fetchVideos = async () => {
      try {
        const response = await api.get(`${baseURL}/api/videos/`);
    ...
    <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
      ...
      >
        ...
        <Paragraph style={{ color: "#666" }}>
          Hover over any card to preview the video. Click anywhere on the card
          to instantly load it into the workspace.
        </Paragraph>
      </div>

      {videos.length === 0 ? (
        <Empty
          description="No videos found in the database yet."
                  ...
                  >
                    <video
                      ...
                      onMouseEnter={(e) => {
                        ...
                        e.currentTarget
                          .play()
                          .catch((err) => console.log("Playback prevented"));
                      }}
                      onMouseLeave={(e) => {
